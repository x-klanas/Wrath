...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_screwing p_screwing;
        ...
        public static SteamVR_Input_ActionSet_screwing screwing
        {
            get
            {
                return SteamVR_Actions.p_screwing.GetCopy<SteamVR_Input_ActionSet_screwing>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_screwing = ((SteamVR_Input_ActionSet_screwing)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_screwing>("/actions/screwing")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.screwing};
        }
    }
}
